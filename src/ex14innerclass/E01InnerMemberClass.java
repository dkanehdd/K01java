...
class OuterMember{
	...
	void outerInstanceMethod() {
		System.out.println("외부의 samaVar:"+sameVar);
		//정적멤버는 클래스명으로 접근한다.
		System.out.println("내부클래스의 상수:"+InnerMember.MAX_INT);
		//내부클래스의 멤버변수를 접근하는경우 참조변수를 사용한다.
		System.out.println("내부의 samaVar:"+inner.sameVar);
	}
...
public class E01InnerMemberClass {
	...
	public static void main(String[] args) {
		...
		//외부클래스의 인스턴스를 먼저 생성한 후 내부클래스의 인스턴스를생성해야 한다.
