...
public class R04array {
	...
	public static void randomCreate(int[] arr) {
		...
		boolean isExist1 = arrayExistElements(arr);
		//중복이 있으면 다시 난수 6개생성
		if(isExist1==false) {
			randomCreate(arr);
		}
	...
	public static void main(String[] args) {
		...
		if(isExist1==true) System.out.println("arr1:중복없음");
		else System.out.println("arr1:중복있음");
		if(isExist2==true) System.out.println("arr2:중복없음");
		else System.out.println("arr2:중복있음");
