...
//		String email1 = "hong@ikosmo.co.kr";
		...
		7] startsWith()
			: 특정 문자열로 시작하면 true, 아니면 false를 반환한다.
		 */
		...
		System.out.println("indexOf:"+str1.indexOf("a"));//12앞에있는a인덱스
		System.out.println("lastIndxOf:"+ str1.lastIndexOf("a"));
		//14뒤에있는a의 인덱스
		...
		12] split()
			...
			반환한다. 해당 구분자가 없는 경우에는 크기가 1인 배열로(분리하지않고) 반환된다.
		 */
		...
		/*
		시나리오] 다음 파일명에서 확장자를 잘라내는 프로그램을작성하시오.
