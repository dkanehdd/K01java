...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*시나리오]
		for문을 이용하여 1~10 사이의 정수중 2의배수의 합을
		구하는 프로그램을 작성하시오.
		 */
		int total = 0;
...
//		}
		...
		/*
		for문의 초기식에서 선언된 변수 j는 for문이 종료되는순간 메모리에서 소멸된다.
		...
		사용할수 있다. 즉 아래에 선언한 변수 i는 main()함수의 지역변수가 된다.
		 */
		int i=0;
		for( ; i<=5 ; i++) {
		...
		for(int x=2 ; x<=9 ; x++) {
			for(int y=1 ; y<=9 ; y++) {
				int re = x*y;
				System.out.printf("%2d*%2d=%2d ", x,y,re);
			}
			System.out.println();
		}
		/*
