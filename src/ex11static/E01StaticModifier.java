...
//		프로그램시작시 이미 메소드영역에 초기화된다.	
	static int staticVar;
	 /*
	 인스턴스형 멤버메소드] 인스턴스형 메소드에서는 모든 멤버를
	 	사용할수있다. 인스턴스형, 정적변수 둘다 접근 가능함.
	  */
	void instanceMethod() {
	...
	정적 멤버메소드] 정적메소드 안에서는 인스턴스 멤버를 사용할수 없다.
		정적멤버만 접근 가능하다.
		(※mail메소드에서는 static으로 선언된 메소드만 호출할수 있었음을 기억하자)
	 */
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		static(정적) 멤버변수 접근방법
		방법1 : 클래스명을 통해서 접근한다. 객체생성없이 바로 접근이 가능하다.
		 */
		...
		*/
		...
		하나만 생성되어 공유되므로, 아래 대입문장은 하나의 변수에 값이 할당되게된다.
