...
public class Ex05HashMapMain {
	...
	public static void main(String[] args) {
		...
		/*
		객체저장 
			: 객체저장시 기존에 저장된 동일한 key값이 존재하면 이전
			객체가 반환된다. 만약 처음이라면 null값이 반환된다.
		 */
		...
		map.put("name1", "홍길동");
		System.out.println(map.put("name1", "동링"));
		/*
		3. 객체수
		 */
		...
		/*
		5-3]반복자를 통한 출력
			: ierator를 통해 반복할때도 keySet()으로 먼저 
			key를 얻어온 후 사용할수 있다.
		 */
		...
		5-4] Value값만 얻어올때 : values() 메소드사용
			:Collection을 통해 map의 벨류들을 가져온후 for문을 통해
			출력한다.
		 */
