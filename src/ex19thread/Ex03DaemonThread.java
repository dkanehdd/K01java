...
독립쓰레드(Non Daemon Thread)
	...
	해당 쓰레드는 main()메소드가 종료된 이후에도 실행되는것을 볼수있다.
 */
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		 ...
		 */
		YesThread yt1 = new YesThread("1st쓰레드");//생성자를통해 이름부여
		//yt1.setName("첫번째쓰레드");//setName()을 통해 이름을 지정할수있다 
		yt1.start();
		...
		yt2.start();
		/*
		종속쓰레드(데몬쓰레드(Daemon Thread))생성 및 실행
		 */
