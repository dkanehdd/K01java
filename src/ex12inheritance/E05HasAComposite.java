...
class Gun{
	...
	public void shutGun() {
		if(bullet<=0) {
			bullet=0;
			System.out.println("탄환 없음");
		}
		else {System.out.println("빵야~~!");
		 bullet--;//탄환이 감소됨
		}
	}
}
...
class Police{
	...
	public void putHandcuff() {
		if(handCuffs<=0) {
			System.out.println("수갑 없음");
		}
		else{System.out.println("수갑채움~ 넌콩밥~");
		handCuffs--;
		}	
	}
	//경찰이 권총을 발사하는 행위를표현
