...
//	}
	...
	/*
	private 접근지정자로 선언된 멤버메소드는 외부 클래스 혹은
	...
	/*
	해당 메소드를 protected로 선언하면 상속관계의 하위객체에서
	호출할 수 있다.
	 */
...
/*
태블릿 노트북 컴퓨터 : 컴퓨터의 기본기능 및 후대이용 기능 그리고 펜으로 드로잉
	할수있는 기능까지 추가된 클래스
 */
class TabletNotebook extends NotebookComputer{
	...
	public void write(String penInfo) {
		...
		/*
		A.compareTo(B)
			 : 문자열 A와B를 비교하여 0이 반환되면 같은문자열로 판단하고
